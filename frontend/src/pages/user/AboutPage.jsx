  ...
  return (
    <main className="page-content">
      <div className="container">
        ...
        <h1 style={{ fontSize: '28px', marginBottom: '8px' }}>Giới thiệu Tech Shop</h1>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '32px', fontSize: '16px', lineHeight: '1.7' }}>
          Đơn vị chuyên thiết bị công nghệ uy tín hàng đầu tại Cần Thơ
        </p>

        {/* Hero Banner */}
        <div className="about-hero">
          <div className="about-hero-content">
            <h2>Tech Shop – Thiết bị số Cần Thơ</h2>
            <p>
              Tech Shop được thành lập với sứ mệnh mang đến cho khách hàng tại Cần Thơ và khu vực Đồng bằng
              sông Cửu Long những thiết bị chất lượng với mức giá hợp lý nhất. Mỗi sản phẩm tại Tech Shop
        ...
        <section className="section" style={{ paddingTop: '24px' }}>
          ...
          <div className="about-values-grid">
            <div className="about-value-card">
              ...
              <p>
                Tất cả sản phẩm đều được kiểm tra phần cứng, phần mềm kỹ lưỡng. Cam kết nguyên zin, 
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          <div className="card" style={{ padding: '40px' }}>
            <h2 style={{ marginBottom: '24px', textAlign: 'center' }}>Tại sao chọn Tech Shop?</h2>
        ...
        <div className="about-cta">
          <Smartphone size={36} />
          <h2>Bạn đang tìm một sản phẩm phù hợp?</h2>
          <p>Liên hệ Tech Shop ngay để được tư vấn miễn phí!</p>
