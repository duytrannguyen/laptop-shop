    ...
    <main className="page-content">
      <div className="container">
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '32px', fontSize: '15px' }}>
          Sở hữu laptop chất lượng chỉ từ 500K/tháng – Duyệt nhanh, thủ tục đơn giản
        </p>
        ...
        <div className="installment-banner">
          ...
          <div>
            ...
            <p>Áp dụng cho tất cả sản phẩm laptop tại Laptop Shop, thủ tục duyệt chỉ trong 15 phút</p>
          </div>
        </div>
            ...
            <div className="policy-section-body">
              <div className="warranty-steps">
                <div className="warranty-step">
                  ...
                  <h4>Chọn sản phẩm</h4>
                  <p>Chọn laptop yêu thích, thông báo muốn mua trả góp</p>
                </div>
                <div className="warranty-step">
                ...
                <div className="warranty-step">
                  ...
                  <h4>Nhận máy</h4>
                  <p>Nhận laptop ngay sau khi hoàn tất thủ tục, trả góp hàng tháng</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="about-cta" style={{ marginTop: '32px' }}>
          ...
          <p>Liên hệ Laptop Shop để được tư vấn phương thức trả góp phù hợp nhất</p>
