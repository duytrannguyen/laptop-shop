    ...
    <main className="page-content">
      <div className="container">
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '32px', fontSize: '15px' }}>
          Laptop Shop cam kết bảo hành minh bạch, rõ ràng cho mọi sản phẩm
        </p>
              ...
              <div className="policy-detail-item">
                ...
                <div>
                  ...
                  <ul className="policy-list">
                    <li>Laptop văn phòng: <strong>6-12 tháng</strong> phần cứng</li>
                    <li>Laptop gaming: <strong>3-6 tháng</strong> phần cứng</li>
                    <li>Macbook: <strong>6-12 tháng</strong> phần cứng</li>
                    <li>Pin laptop: <strong>3 tháng</strong> (pin trên 80% sức khỏe)</li>
              ...
              <div className="policy-detail-item">
                ...
                <div>
                  ...
                  <ul className="policy-list">
                    ...
                    <li>Phí ship đổi trả do Laptop Shop chi trả (nếu lỗi từ sản phẩm)</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="about-cta" style={{ marginTop: '32px' }}>
          ...
          <p>Liên hệ Laptop Shop qua hotline hoặc mang máy trực tiếp đến cửa hàng</p>
